  ...
  return (
    <>
      ...
      <div className="text-white flex items-center justify-center mt-3 mb-5">
        ...
        >
          <svg className="w-8 h-8 shrink-0 mt-2 ms-1 fill-neutral-50">
            <Download className="text-white text-2xl h-8 w-8 mt-5" />
          </svg>
          <span className="origin-left inline-flex duration-100 group-hover:duration-300 group-hover:delay-300 opacity-0 group-hover:opacity-100 border-l-2 px-2 transform scale-x-0 group-hover:scale-x-100 transition-all">
